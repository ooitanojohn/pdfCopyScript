      ...
      <body>
           ...
           <nav id="breadcrumbs">
               <ul>
                    ...
                    <li><a
 href="/ph35/scottadmin/public/dept/showDeptList.php">部門リスト</a></li>
                    <li>部門情報編集</li>
               </ul>
           </nav>
  <?php
  ...
  ?>
   ...
   ?>
                ...
                <form action="/ph35/scottadmin/public/dept/deptEdit.php" method="post"
 class="box">
                     部門ID:&nbsp;<?= $dept->getId() ?><br>
                     <input type="hidden" name="editDpId" value="<?= $dept->getId() ?>">
                     <label for="editDpNo">
                         部門番号&nbsp;<span class="required">必須</span>
                         <input type="number" min="10" max="90" step="10" id="editDpNo"
 name="editDpNo" value="<?= $dept->getDpNo() ?>" required>
                     </label><br>
                     <label for="editDpName">
                         部門名&nbsp;<span class="required">必須</span>
                         <input type="text" id="editDpName" name="editDpName" value="<?=
 $dept->getDpName() ?>" required>
                     </label><br>
                     <label for="editDpLoc">
                         所在地
                         <input type="text" id="editDpLoc" name="editDpLoc" value="<?=
 $dept->getDpLoc() ?>">
                     </label><br>
