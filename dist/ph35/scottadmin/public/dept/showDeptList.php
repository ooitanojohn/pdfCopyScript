 ...
 /**
  ...
  <html lang="ja">
        <head>
            ...
            <link rel="stylesheet" href="/ph35/scottadmin/public/css/main.css"
 type="text/css">
        </head>
        <body>
            <h1>部門情報リスト</h1>
            ...
            <section>
                 <p>
                      新規登録は<a
 href="/ph35/scottadmin/public/dept/goDeptAdd.php">こちら</a>から
                 </p>
          </section>
          <section>
              <table>
  ...
  ?>
                       <tr>
                           ...
                           <td><?= $dept->getDpLoc() ?></td>
                            <td>
                                <form
 action="/ph35/scottadmin/public/dept/prepareDeptEdit.php" method="post">
                                    <input type="hidden" id="editDeptId<?= $dept->getId()
 ?>" name="editDeptId" value="<?= $dept->getId() ?>">
                                    <button type="submit">編集</button>
                                </form>
                            </td>
                            <td>
                                <form
 action="/ph35/scottadmin/public/dept/confirmDeptDelete.php" method="post">
                                    <input type="hidden" id="deleteDeptId<?= $dept->getId()
 ?>" name="deleteDeptId" value="<?= $dept->getId() ?>">
